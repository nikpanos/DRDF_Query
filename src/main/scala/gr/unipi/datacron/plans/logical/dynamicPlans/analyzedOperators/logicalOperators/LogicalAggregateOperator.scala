...
case class LogicalAggregateOperator(leftChild: BaseOperator with BooleanTrait, rightChild: BaseOperator with BooleanTrait, aggregation: LogicalAggregateEnum) extends Base2ChildOperator(leftChild, rightChild, false) with BooleanTrait {
